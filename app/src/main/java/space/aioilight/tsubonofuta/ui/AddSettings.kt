...
import space.aioilight.tsubonofuta.hook.IHook
import space.aioilight.tsubonofuta.hook.ModuleMain
        ...
        XposedBridge.hookAllMethods(
            ...
            object : XC_MethodHook() {
                override fun afterHookedMethod(param: MethodHookParam) {
                    ...
                    layoutParams.topMargin = dpToPx(10, activity)
